    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open http://www.anticoborgonarcao.it/media/hack%20By.html')
                time.sleep(2)
                menu()
